...
void UIregisterComponents() {
    ...
    components_manager->register_component(temp);
    components_manager->register_component(press);
    ...
    components_manager->register_component(wifi_indicator);
    components_manager->register_component(server_indicator);
    components_manager->register_component(thermometer);
}
